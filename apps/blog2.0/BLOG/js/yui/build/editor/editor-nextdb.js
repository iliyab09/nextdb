...
var Dom = YAHOO.util.Dom,
    ...
    */
    ...
    YAHOO.extend(YAHOO.widget.SimpleEditor, YAHOO.util.Element, {
        ...
        * @type String
        */
        STR_IMAGE_HERE: 'Image URL Here (either uploaded or remote)',
        /**
        ...
        */
        _handleInsertImageClick: function() {
            ...
            var _handleAEC = function() {
                var el = this.currentElement[0], src = 'http://';
                if (!el) {
                    el = this._getSelectedElement();
                }
                if (el) {
    ...
    YAHOO.extend(YAHOO.widget.Editor, YAHOO.widget.SimpleEditor, {
        ...
        */
        _renderInsertImageWindow: function() {
                var el = this.currentElement[0];
//                var str = '<table><tr><td><label for="upload">disk: </td><td><span id="nextdb-image-loader-"></span><span id="nextdb-image-loader"></span></td></label></td></tr></table>';
                var str = '<span id="nextdb-image-loader-progress"></span><span id="nextdb-image-loader"></span>';
                str+=     '<label for="' + this.get('id') + '_insertimage_url"><strong>' + this.STR_IMAGE_URL + ':</strong> <input type="text" id="' + this.get('id') + '_insertimage_url" value="" size="40"></label>';
                var body = document.createElement('div');
                body.innerHTML = str;
